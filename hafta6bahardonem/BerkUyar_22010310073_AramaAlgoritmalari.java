package hafta6bahardonem;

public class BerkUyar_22010310073_AramaAlgoritmalari {
	...
	public static void main(String[] args) {
		...
		if(index != -1) {
			System.out.println("Aranan eleman bulundu. " + (index + 1) + " sirada");
		}	
		else {
		...
		int [] numbers3 = {1, 3, 12, 14, 23, 34, 55, 65, 75, 78 };
		index = binarySearchR(numbers3, 80 , 0, numbers3.length-1);
			if(index != -1) {
				System.out.println("Aranan eleman bulundu. " + index  + " sirada");
			}	
			else {
				System.out.println("Aranan eleman bulunamadi.");
